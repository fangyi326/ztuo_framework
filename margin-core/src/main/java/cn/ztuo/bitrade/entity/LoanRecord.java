...
public class LoanRecord {
     ...
     */
    @Column(columnDefinition = "decimal(18,8) comment '未归还的借贷金额'")
    private BigDecimal amount;

    @Column(columnDefinition = "decimal(18,8) comment '借贷利率'")
    private BigDecimal interestRate;

    /**
     * 借贷金额（记录值，不变化）
     */
    @Column(columnDefinition = "decimal(18,8) comment '借贷金额（记录值，不变化）'")
    private BigDecimal loanBalance=BigDecimal.ZERO;

    /**
     * 累计利息
     */
    @Column(columnDefinition = "decimal(18,8) comment '累计利息'")
